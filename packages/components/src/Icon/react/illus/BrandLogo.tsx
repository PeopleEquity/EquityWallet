...
const SvgBrandLogo = (props: SvgProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 128 128" enableBackground="new 0 0 128 128" width={props?.width} height={props?.height}>
    <g>
